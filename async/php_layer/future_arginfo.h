 ...
 * Stub hash: 257bca86c14de4ea66dd9bd1b295a206b3a802c3 */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Async_FutureState_toString, 0, 0, IS_STRING, 0)
ZEND_END_ARG_INFO()
...
ZEND_METHOD(Async_FutureState, toString);
...
static const zend_function_entry class_Async_FutureState_methods[] = {
	...
	ZEND_ME(Async_FutureState, toString, arginfo_class_Async_FutureState_toString, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};
