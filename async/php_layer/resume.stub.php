...
final class Resume
{
    ...
    public function when(NotifierInterface $notifier, callable $callback): static {}

    public function resumeWhen(NotifierInterface $notifier): static {}

    public function throwWhen(NotifierInterface $notifier): static {}
}
