...
static zend_always_inline void zval_c_buffer_new(size_t count, const allocator_t *allocator)
{
...
static zend_always_inline void zval_c_buffer_push_with_resize(circular_buffer_t *buffer, zval *value)
{
...
static zend_always_inline void zval_c_buffer_push(circular_buffer_t *buffer, zval *value)
{
...
static zend_always_inline void zval_c_buffer_pop(circular_buffer_t *buffer, zval *value)
{
	ZVAL_UNDEF(value);
